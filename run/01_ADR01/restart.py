...
def run_continuation(scenario=CHILD_SCENARIO, end_time=1800.0):
    ...
    manifest = {
        ...
        "parent_manifest": parent_manifest_path.relative_to(CASE_DIR).as_posix(),
        "restart_checkpoint": checkpoint_path.relative_to(CASE_DIR).as_posix(),
        "restart_time_s": RESTART_TIME_S,
        "parent_git_commit": parent["git_commit"],
        "parent_git_dirty": parent["git_dirty"],
